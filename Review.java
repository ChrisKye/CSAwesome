 ...
 */
  ...
  */
  public static int starRating(String filename)
  {
    ...
    if (rating >= 15) stars = 4;
    else if (rating >= 10) stars = 3;
    else if (rating >= 5) stars = 2;
    else if (rating >= 0) stars = 1;
    else if (rating <= 0) stars = 0;

  
    // return number of stars
    return stars; 
  }
// Activity 3 Fake Review
  public static String fakeReview(String filename){
    String review = textToString(filename);
    int i = 0;
    while (i != -1) {
      i = review.indexOf("*");
      String temp = review.substring(i);
      int f = temp.indexOf(" ");
      
      String front = review.substring(0,i);
      String back = review.substring(i+f);
